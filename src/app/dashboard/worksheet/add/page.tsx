...
import { postWorksheet } from "@/services/file";
...
export default function AddWorksheetPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await postWorksheet(JSON.stringify(payload));

      setModalMessage("Worksheet saved successfully!");
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      console.error(err);
      setModalMessage("Failed to save worksheet.");
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">Worksheet</h1>
      <section>
        <form
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full shadow-lg text-center space-y-4">
            ...
            <button
              onClick={() => {
                if (modalSuccess) router.push("/dashboard/worksheet");
              }}
