...
import { deleteFile, fetchWorksheets, File } from "@/services/file";
...
export default function WorksheetPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setData(prev => prev.filter(worksheet => worksheet.id !== idToDelete));
      setIdToDelete(null);
    } catch (error) {
  ...
  const handleAddNewWorksheet = () => {
    router.push('/dashboard/worksheet/add')
  }
